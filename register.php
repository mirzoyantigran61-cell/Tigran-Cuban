...
<head>
    ...
    <title>Register - Cuban Mods</title>
...
<div class="social-float-container">
    ...
    <button id="social-main-btn" class="social-main-button" aria-label="Redes Sociales">
        ...
        <main class="p-4 md:p-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-600 dark:text-gray-400">Join the modding community</p>
            </div>
                ...
                <form method="POST" class="space-y-5" id="register-form">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               required
                               value=""
                               class="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-slate-900 dark:text-white focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all outline-none"
                    ...
                    <div>
                        ...
                        <input type="email" 
                               ...
                               disabled
                               value=""
                               class="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-slate-900 dark:text-white focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all outline-none disabled:bg-slate-100 dark:disabled:bg-gray-800/50 disabled:cursor-not-allowed"
                    ...
                    <div>
                        ...
                        <input type="password" 
                               ...
                               class="w-full px-4 py-3 rounded-xl border border-slate-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-slate-900 dark:text-white focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all outline-none disabled:bg-slate-100 dark:disabled:bg-gray-800/50 disabled:cursor-not-allowed"
                               placeholder="••••••••">
                        <p class="text-xs text-slate-500 dark:text-gray-400 mt-1">Minimum 6 characters</p>
                    </div>
                    ...
                    <label class="flex items-start gap-2 cursor-pointer">
                        <input type="checkbox" required class="w-4 h-4 mt-1 rounded border-slate-300 dark:border-gray-600 text-purple-500 focus:ring-2 focus:ring-purple-500/20">
                        <span class="text-sm text-slate-600 dark:text-gray-400">
                            I accept the <a href="#" class="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium">terms and conditions</a> and the <a href="#" class="text-purple-600 dark:text-purple-400 hover:text-purple-700 dark:hover:text-purple-300 font-medium">privacy policy</a>
                        </span>
                    </label>
                    
                    <!-- Submit Button -->
                    <button type="submit" 
                            class="w-full py-3.5 bg-gradient-to-r from-purple-500 to-purple-600 hover:from-purple-600 hover:to-purple-700 text-white font-semibold rounded-xl shadow-lg shadow-purple-500/30 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/40 hover:-translate-y-0.5">
            ...
            <p class="text-center mt-6 text-slate-600 dark:text-gray-400">
                ...
                <a href="/login.php" class="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-semibold">Login</a>
            </p>
    ...
    <script>
        // ═══════════════════════════════════════════════════════════════
        // DESBLOQUEO PROGRESIVO DE CAMPOS
        // ═══════════════════════════════════════════════════════════════
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Desbloquear email cuando username tenga al menos 3 caracteres
            username.addEventListener('input', function() {
                if (this.value.trim().length >= 3) {
                    email.disabled = false;
                    email.classList.add('animate-pulse');
                    setTimeout(() => email.classList.remove('animate-pulse'), 500);
                } else {
                    email.disabled = true;
            ...
            // Desbloquear password cuando email sea válido
            email.addEventListener('input', function() {
                const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
                if (emailRegex.test(this.value.trim())) {
                    password.disabled = false;
                    password.classList.add('animate-pulse');
                    setTimeout(() => password.classList.remove('animate-pulse'), 500);
                } else {
                    password.disabled = true;
                    confirmPassword.disabled = true;
                }
            ...
            // Desbloquear confirm password cuando password tenga al menos 6 caracteres
            password.addEventListener('input', function() {
                if (this.value.length >= 6) {
                    confirmPassword.disabled = false;
                    confirmPassword.classList.add('animate-pulse');
                    setTimeout(() => confirmPassword.classList.remove('animate-pulse'), 500);
                } else {
                    confirmPassword.disabled = true;
                }
            });
